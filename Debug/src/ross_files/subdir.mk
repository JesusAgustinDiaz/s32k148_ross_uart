...
src/ross_files/s32k148_time.o: ../src/ross_files/s32k148_time.c
	...
	arm-none-eabi-gcc "@src/ross_files/s32k148_time.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "src/ross_files/s32k148_time.o" "$<"
...
src/ross_files/s32k148_uart.o: ../src/ross_files/s32k148_uart.c
	...
	@echo 'Invoking: Standard S32DS C Compiler'
	arm-none-eabi-gcc "@src/ross_files/s32k148_uart.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "src/ross_files/s32k148_uart.o" "$<"
	@echo 'Finished building: $<'
	@echo ' '
